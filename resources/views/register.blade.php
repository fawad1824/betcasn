        ...
        <div class="flex bg-white mt-20">
            ...
            <div x-show="activeTab === 'email'" class="p-6  w-full">
                <main class="flex items-center justify-between">
                    <div class="flex-row">
                        <h1 class="text-3xl"><b>Register</b></h1>
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-2 border rounded">
                        <input type="text" placeholder="Your Password" class="w-full p-2 border-none outline-none">
                        <button class="p-2 rounded text-black w-1/3">
                            Get Verification Code
                        </button>
                    </div>
                    <h1 class="text-sm mt-5 mb-10"><a href="/forget">Forgot Password?</a></h1>
                    <button class="w-full bg-black text-white p-2 rounded mt-3">Next Step</button>
                </div>
            </div>
