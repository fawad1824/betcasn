...
<body class="bg-gray-100 flex flex-col min-h-screen">
    ...
    <header
        ...
        <nav class="flex space-x-4 relative" x-data="{ showLangModal: false }">
            ...
            <div x-show="showLangModal" @click.away="showLangModal = false"
                class="fixed left-0 top-0 h-full w-64 bg-white shadow-lg p-4 transform -translate-x-full transition-transform duration-300 ease-in-out"
    ...
    <main class="mt-20 w-[100%] m-5 mb-20">
        <div class="image">
        ...
        <div class="games w-full mt-10 m-auto">
            ...
            <div class="overflow-x-auto scrollbar-hide">
                <div class="flex">
                    ...
                    <div class="w-64 bg-[#f7f7f7] rounded-lg  overflow-hidden">
                     ...
                     <!-- Game Card 5 -->
                     <div class="w-64 bg-[#f7f7f7] rounded-lg  overflow-hidden">
                        <img src="https://www.betcasn.com/images/games/game3_bg.webp" alt="Game 5"
                            class="w-full h-40 object-cover">
                        <div class="p-3">
                            <div class="flex items-center gap-2">
                                <img src="https://www.betcasn.com/images/games/game3.webp" alt="Avatar"
